...
- **Remote operator access**: use an SSH tunnel; non-loopback browser operation
  ...
  of remaining legacy tracking/control aliases, typed migration of still-legacy
...
migration of still-legacy tracking/control mutations, retirement of remaining
legacy aliases, adversarial auth/media tests, and evidence gates are complete.
