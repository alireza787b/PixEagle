...
- [GimbalTracker](../../trackers/02-reference/gimbal-tracker.md) - Uses coordinate transforms
- [GM Velocity Chase Follower](../../followers/02-reference/gm-velocity-chase.md) - Velocity calculations
