...
the 2026-06-19 tracking/control alias-retirement slice. PXE-0064 remains open
for operator credential/TLS hardening and broader adversarial browser/session/media
tests. No runtime MCP endpoint, executor, `tools/list`, `tools/call`, or
