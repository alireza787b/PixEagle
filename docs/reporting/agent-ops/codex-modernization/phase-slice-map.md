...
legacy fallback only for missing or unsupported typed routes. The 2026-07-01
...
or unsupported. Remaining PXE-0008 API work now focuses on typed tracker
restart/configuration mutation design, fallback telemetry and tracked
