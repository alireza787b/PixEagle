...
- PXE-0064 first containment foundation: backend/dashboard/MAVLink2REST
  ...
  PXE-0064 work is operator credential/TLS hardening, typed replacements and
  retirement for remaining legacy tracking/control mutations, and broader
...
- PXE-0064 runtime auth foundation: route policy is enforced before HTTP/MJPEG
  ...
  aliases. PXE-0064 remains open for operator credential/TLS hardening, typed
  replacements/retirement for remaining legacy tracking/control mutations, and
  broader adversarial tests.
