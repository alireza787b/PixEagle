...
| --- | --- | --- | --- |
| 5 | v7 beta acceptance closure and public refresh | PXE-0105 done; PXE-0106 in progress; PXE-0074 partial | Beta.4 is published at `f16133de` and the exact public VPS runtime is healthy. Live dashboard/auth/media probes pass, and the no-touch beta4 setup/profile/schema/API handoff passes 23/23; the updater check remains a stopped-runtime gate by design. Next is maintainer VPS retest, then fresh Ubuntu and physical Raspberry Pi Core/Full/model evidence under PXE-0074. Do not imply GStreamer source-build, production TLS, public WebRTC, QGC, PX4/SIH/SITL/HIL, field, follower-response, or aircraft readiness. |
