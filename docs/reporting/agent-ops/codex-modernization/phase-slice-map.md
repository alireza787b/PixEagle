...
| 4 | WebRTC and operator dashboard UX | PXE-0075, PXE-0076 | Diagnose user-observed WebRTC fallback, then redesign Settings plus Tracker Data/Follower Data for responsive mobile/tablet/desktop operation, bounded precision, low-noise operator summaries, and screenshot-backed validation. |
