...
WebSocket dropped-frame overcount found by new direct send-loop tests. Remaining
PXE-0008 legacy route-body cleanup includes WebRTC signaling route bodies and a
separate circuit-breaker mutation cleanup before typed `/api/v1` replacements or
tracked compatibility retirement.
