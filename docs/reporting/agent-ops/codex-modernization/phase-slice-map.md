...
legacy AppController state mutation. Remaining PXE-0008 API work now focuses
on the heavier legacy tracker diagnostics, typed `/api/v1` replacements, tracked
