...
| 4 | Operator dashboard UX | PXE-0076 | WebRTC public HTTP Auto policy is fixed under PXE-0075. Next redesign Settings plus Tracker Data/Follower Data for responsive mobile/tablet/desktop operation, bounded precision, low-noise operator summaries, and screenshot-backed validation. |
