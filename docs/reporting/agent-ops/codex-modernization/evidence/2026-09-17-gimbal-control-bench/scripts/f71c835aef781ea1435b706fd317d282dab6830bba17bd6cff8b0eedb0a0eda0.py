...
def main():
    ...
    parser.add_argument('phase', choices=['queries', 'routing', 'video', 'observe', 'describe',
                        'ai-observe', 'stops', 'tracking-ready', 'pan', 'tilt', 'pan-step', 'tilt-step', 'zoom', 'home', 'point', 'box'])
    ...
    control = args.phase in ('ai-observe', 'stops', 'tracking-ready', 'pan', 'tilt', 'pan-step', 'tilt-step', 'zoom', 'home', 'point', 'box')
        ...
        if args.phase in ('queries', 'routing') or control:
            ...
            if control:
                ...
                def independent_stop():
                    ...
                    if stop_event.wait(18 if args.phase == 'ai-observe' else 8):
                        return
                ...
                if args.phase == 'ai-observe':
                    ...
                    for _ in range(6):
                        send(b'#TPPD2rTRA00', 'tracker_fault_query')
                        poll(1.2)
