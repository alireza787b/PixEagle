...
def main():
    ...
    parser.add_argument('phase', choices=['queries', 'routing', 'video', 'observe', 'describe',
                        'stops', 'tracking-ready', 'pan', 'tilt', 'pan-step', 'tilt-step', 'zoom', 'home', 'point', 'box'])
    ...
    parser.add_argument('--speed', type=int, choices=[5, 10, 20], default=5)
    parser.add_argument('--direction', type=int, choices=[-1, 1], default=1)
    args = parser.parse_args()
    control = args.phase in ('stops', 'tracking-ready', 'pan', 'tilt', 'pan-step', 'tilt-step', 'zoom', 'home', 'point', 'box')
