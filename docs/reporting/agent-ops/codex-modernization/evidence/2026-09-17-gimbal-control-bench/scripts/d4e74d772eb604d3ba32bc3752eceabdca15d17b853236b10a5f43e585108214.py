...
def main():
    ...
    parser.add_argument('--x', type=float, choices=[0.15, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.85], default=0.5)
    parser.add_argument('--y', type=float, choices=[0.15, 0.25, 0.3, 0.4, 0.5, 0.6, 0.7, 0.75, 0.85], default=0.5)
    parser.add_argument('--descriptor', type=int, choices=[0,1,8,9], default=None)
    parser.add_argument('--track-seconds', type=int, choices=[1,4,6], default=1)
