...
| [Native Windows x64 Core Preview](WINDOWS_SETUP.md) | Opt-in authenticated loopback bundled-video candidate; native CI passed, clean-host operator evidence pending |
