...
const approvedApiPaths = new Set([
  ...
  '/pixeagle-api/api/tracker/available',
  '/pixeagle-api/api/tracker/available-types',
  '/pixeagle-api/api/tracker/current',
  '/pixeagle-api/api/tracker/current-config',
  '/pixeagle-api/api/tracker/current-status',
  '/pixeagle-api/api/tracker/output',
