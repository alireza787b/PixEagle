...
API_V1_ROUTE_SPECS: tuple[ApiV1RouteSpec, ...] = (
    ...
    ApiV1RouteSpec(
        ...
        handler="get_auth_tokens",
        response_model="APIAuthTokensResponse",
        responses="AUTH_ROUTE_RESPONSES",
    ...
    ApiV1RouteSpec(
        ...
        response_model="APIAuthTokenCreateResponse",
        responses="AUTH_ROUTE_RESPONSES",
    ...
    ApiV1RouteSpec(
        ...
        handler="revoke_auth_token",
        response_model="APIAuthTokenRevokeResponse",
        responses="AUTH_ROUTE_RESPONSES",
        operation_id="revoke_auth_token",
        tags=("auth",),
    ),
    ApiV1RouteSpec(
        method="GET",
